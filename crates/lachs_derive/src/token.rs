...
pub fn impl_token_macro(ast: syn::DeriveInput) -> TokenStream {
    ...
    let gen = quote! {
        ...
        impl #ident {
            ...
            pub fn lex(input: impl ToString) -> gen::LexResult<Vec<#ident>> {
                gen::Lexer::new(input.to_string().as_str()).lex()
            }
        }
        ...
        mod gen {
            ...
            type Entries = Vec<(Regex, Box<dyn Fn(Match, EntryInputSpan, String) -> super::#ident>)>;
            ...
            impl<'a> Lexikon {
                ...
                fn insert<F: Fn(Match, EntryInputSpan, String) -> super::#ident + 'static>(entries: &mut Entries, reg: Regex, f: F) {
            ...
            impl<'a> Lexer<'a> {
                ...
                pub fn lex(mut self) -> LexResult<Vec<super::#ident>> {
